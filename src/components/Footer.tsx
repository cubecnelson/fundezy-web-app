    ...
    <footer className="bg-gray-950 border-t border-gray-800">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-8">
        ...
        <nav className="mt-4 flex flex-wrap justify-center space-x-6" aria-label="Legal">
          <a href="/tnc" className="text-sm text-gray-400 hover:text-fundezy-red">Challenge Terms and Conditions</a>
          <a href="/use_of_website" className="text-sm text-gray-400 hover:text-fundezy-red">Conditions for Use of Website</a>
          <a href="/disclaimers_and_legal" className="text-sm text-gray-400 hover:text-fundezy-red">Disclaimers and Legal Information</a>
          <a href="/pps" className="text-sm text-gray-400 hover:text-fundezy-red">Privacy Policy Statement</a>
          <a href="/pics" className="text-sm text-gray-400 hover:text-fundezy-red">Personal Information Collection Statement (PICS)</a>
        </nav>
